...
function HomeFooter() {
  ...
  const socialLinks = [
    { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/rudransh-gupta-0a2570329/", color: "hover:text-blue-700" },
    { name: "Instagram", icon: Instagram, href: "https://instagram.com/rudransh.ai", color: "hover:text-pink-600" },
    { name: "YouTube", icon: Youtube, href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=RDdQw4w9WgXcQ&start_radio=1", color: "hover:text-red-600" },
    { name: "Github", icon: Github, href: "https://github.com/Rudrxxx", color: "hover:text-gray-600" }
  ];
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 lg:space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed max-w-md text-sm hidden md:block">
              ...
              Build your career, grow your business, and achieve your goals with SkillConnect.
            </p>
            ...
            <div className="space-y-2 lg:space-y-3">
              <div className="flex items-center gap-2 lg:gap-3 text-gray-300">
                ...
                <span className="text-xs lg:text-sm">hello@SkillConnect.com</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 lg:gap-4">
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 text-gray-400 text-xs lg:text-sm text-center md:text-left">
              <span>© 2025 SkillConnect. All rights reserved.</span>
              <div className="hidden md:flex items-center gap-1">
                <span>Made with</span>
                <Heart className="w-4 h-4 text-red-500 fill-current" />
                <span>by Rudransh Gupta</span>
              </div>
            </div>
