      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-6 py-4 flex flex-row justify-between">
          <div className="flex items-center space-x-3">
            ...
            />
            <div>
              <h1 className="text-2xl font-bold text-gray-900">SkillConnect</h1>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Please read these terms carefully before using the SkillConnect platform. 
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-4 border-blue-500 pl-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing or using the SkillConnect Platform (&quot;Platform&quot;), you agree to comply with and be bound by these Terms and Conditions (&quot;Terms&quot;). If you do not agree, do not use the Platform.
              </p>
            </div>
            ...
            <div className="border-l-4 border-teal-500 pl-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                All payments are made directly between freelancers and clients. SkillConnect does not hold funds or offer payment guarantees.
              </p>
            </div>
            ...
            <div className="border-l-4 border-indigo-500 pl-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                All original platform content is owned by SkillConnect and cannot be copied or reused without written permission.
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Image
                ...
                height={100}
              />
              <span className="text-lg font-semibold">SkillConnect</span>
            </div>
            <div className="text-sm text-gray-400">
              © 2025 SkillConnect.<br></br> All rights reserved.
            </div>
          </div>
        </div>
      </footer>
